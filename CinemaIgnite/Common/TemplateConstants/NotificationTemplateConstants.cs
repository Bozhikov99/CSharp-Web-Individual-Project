...
namespace Common.TemplateConstants
{
    public class NotificationTemplateConstants
    {
        ...
        public const string TicketsBoughtTitle = "Закупени билети";
        ...
        public const string TicketBoughtMessage = "Информираме ви, че успешно закупихте билет за филма {0} на {1} в {2} часа.";
        public const string TicketsBoughtMessage = "Информираме ви, че успешно закупихте билети за филма {0} на {1} в {2} часа.";
